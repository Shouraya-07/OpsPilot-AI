...
export function ChatbotInterface({ isOpen, onClose, onWorkflowChange, currentOperation }: ChatbotInterfaceProps) {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      console.log('About to send message to AI backend');
      console.log('Current operation:', currentOperation);
      console.log('Message text:', messageText);
      
      // Send message to AI backend with robust error handling
      const response = await apiService.sendChatMessage({
        message: messageText,
        operation_type: currentOperation || 'terminal',
        context: {
      ...
      const botResponse: ChatMessage = {
        id: Date.now().toString(),
        type: 'bot',
        message: response.response || "I'm here to help with your terminal operations!",
        timestamp: new Date(),
      ...
      console.log('Created bot response:', botResponse);
      ...
      // Always show a response, even if there's an error
      setTimeout(() => {
